    ...
    <div class="row align-items-center">
        <div class="col">
            <div class="mt-5">
                ...
                <a href="{{ route('category.create') }}" class="btn btn-primary float-right veiwbutton">Ajouter une
                    categorie</a>
            </div>
        </div>
    </div>
                                        ...
                                        <td class="text-right">
                                            <div class="dropdown dropdown-action"> <a href="#"
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right"> <a class="dropdown-item"
                                                        ...
                                                        Modifier</a> <a class="dropdown-item"
                                                        href="{{ route('category.destroy', $category) }}" data-toggle="modal"
